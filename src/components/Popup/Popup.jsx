        ...
        {orderPopup && (
            <div className='popup'>
                <div className='h-screen w-screen fixed top-0
                    ...
                    -translate-y-1/2 p-4 shadow-md bg-white dark:bg-gray-900 rounded-md duration-200 w-[300px]'>
                        {/* Header */}
                        ...
                        <div className='mt-4'>
                            <input 
                                ...
                                border-gray-300 dark:border-gray-500 dark:bg-fray-800 px-2 py-1 mb-4'
                            />
                            <input 
                                type='text'
                                placeholder='Email'
