...
import Img1 from '../../assets/shirt/images1.jpg'
import Img2 from '../../assets/shirt/iamges2.jpg'
import Img3 from '../../assets/shirt/images3.jpg'
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-20 md:gap-5 place-items-center'>
                {
                    ProductsData.map((data) => (
                        <div 
                            ...
                            hover:bg-black/80 dark:hover:bg-primary dark:text-white hover:text-white relative
                            shadow-xl duration-300 group max-w-[300px]
                            '>
                            {/* image section */}
                            <div className='h-[100ox]'>
                                <img 
                                    src={data.img} alt=''
